...
<form action="createuser" method="post" name="info">
   ...
   <%}else{ %>
    ...
    <%if(userNew.getCabang()==null){ %>
      <tr><td class="item">Cabang</td><td class="item"><input type="text" name="cabang"size="30" ></td></tr>
    <%}else{ %>
     <tr><td class="item">Cabang</td><td class="item"><input type="text" name="department" value="<%=userNew.getCabang()%>" size="30" ></td><tr>
     <%} %>
