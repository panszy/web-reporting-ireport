...
<form action="createuser" method="post" name="info">
   ...
   <%}else{ %>
    ...
    <%if(userNew.getDepartemen()==null){ %>
      <tr><td class="item">Department</td><td class="item"><input type="text" name="department"size="30" onKeypress="uppercase();"></td></tr>
    <%}else{ %>
     <tr><td class="item">Department</td><td class="item"><input type="text" name="department" value="<%=userNew.getDepartemen()%>" size="30" onKeypress="uppercase();"></td><tr>
     <%} %>
