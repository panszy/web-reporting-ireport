...
<table class="item"
    ...
    <td class="item" colspan="<%=tableColumn.size()%>">
        <input type="submit" name="Action" value="Approve" onClick="deletes(<%=i%>)"></button>      
        <input type="submit" name="Action" value="Protect" onClick="deletes(<%=i%>)"></button>
        <input type="submit" name="Action" value="Cancel" onClick="deletes(<%=i%>)"></button>
    </td>
    <td class="item">
