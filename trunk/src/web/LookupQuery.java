...
public class LookupQuery {
	...
	final public static String kodeSOQuery = "select \"DB2ADMIN\".TBSO_SMS.no_so_sms,\"DB2ADMIN\".TBSO_SMS.tgl_so_sms,\"DB2ADMIN\".TBSO_SMS.no_po,\"DB2ADMIN\".TBSO_SMS.tgl_po, ROW_NUMBER() OVER(ORDER BY \"DB2ADMIN\".TBSO_SMS.tgl_so_sms DESC) AS ROWNUMBER from \"DB2ADMIN\".TBSO_SMS where \"DB2ADMIN\".TBSO_SMS.F_SOBATAL=0 and \"DB2ADMIN\".TBSO_SMS.F_APPCAB=0 and \"DB2ADMIN\".TBSO_SMS.F_APPPROTEK=0";
	final public static String kodeSOQueryTable = "\"DB2ADMIN\".TBSO_SMS";
